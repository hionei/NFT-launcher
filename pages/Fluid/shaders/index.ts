...
export const DISPLAY_SHADER_SRC = `
precision highp float;
precision highp sampler2D;
...
export const BLOOM_PREFILTER_SHADER_FRAG = `
precision mediump float;
precision mediump sampler2D;
